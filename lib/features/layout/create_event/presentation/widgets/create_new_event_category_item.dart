...
class CreateNewEventCategoryItem extends StatelessWidget {
  const CreateNewEventCategoryItem({
    super.key,
  ...
  Color getBorderColor(ThemeToggler theme) {
    ...
    return theme.isLight ? AppColors.primaryColor : AppColors.primaryColor;
  }

  Color getIconAndTextColor(ThemeToggler theme) {
    if (isSelected) {
      return theme.isLight ? AppColors.white : AppColors.black;
    }
